...
import { WECHAT_ACCESS_TOKEN_NAME, EVENT_QUEUE_NAME, WECHAT_BIND_TOKEN_NAME, TOAST_DURATION, WECHAT_Refresh_TOKEN_NAME, WECHAT_APP_NAME, WECHAT_TOKEN_TYPE_NAME } from '../common/js/config'
    ...
    return new Promise((resolve, reject) => {
      ...
      wepy.request({
        ...
        success(res) {
          ...
          let errorCode = data.errorCode === undefined ? 'none' : Number(data.errorCode);
